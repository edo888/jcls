        ...
        <tr>
            <td colspan="2">
                <table cellspacing="0" cellpadding="0">
                    <tr><td style="border-right:3px solid black;">&nbsp;</td><td colspan="4" style="border-right:3px solid black;border-top:3px solid black;text-align:center;padding:5px;"><?php echo JText::_('CLS_OHS_CURRENT_MONTH'); ?></td></tr>
                    <tr><td style="border-right:3px solid black;">&nbsp;</td><td></td><td></td><td style="padding:5px;"><?php echo JText::_('CLS_OHS_MONTH'); ?></td><td style="border-right:3px solid black;"></td></tr>
        ...
        <tr>
            <td colspan="2">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr><td style="border-left:3px solid black;"><?php echo JText::_('CLS_OHS_TRAFFIC_ACCIDENTS_INVOLVING_PROJECT_VEHICLES_EQUIPMENT'); ?></td><td><input type="text" onchange="recalculateRates()" name="traffic_accidents_involving_project_vehicles_equipment" size="1" maxlength="5" value="<?php echo $this->session->get('cls_traffic_accidents_involving_project_vehicles_equipment', 0); ?>" /></td><td style="border-right:3px solid black;"></td></tr>
                    <tr><td style="border-left:3px solid black;"><?php echo JText::_('CLS_OHS_ACCIDENTS_INVOLVING_NON_PROJECT_VEHICLES_OR_PROPERTY'); ?>  </td><td><input type="text" onchange="recalculateRates()" name="accidents_involving_non_project_vehicles_or_property" size="1" maxlength="5" value="<?php echo $this->session->get('cls_accidents_involving_non_project_vehicles_or_property', 0); ?>" /></td><td style="border-right:3px solid black;"></td></tr>
                    <tr><td style="border-left:3px solid black;"><?php echo JText::_('CLS_OHS_ENVIRONMENTAL_INCIDENT'); ?>                                </td><td><input type="text" onchange="recalculateRates()" name="environmental_incident" size="1" maxlength="5" value="<?php echo $this->session->get('cls_environmental_incident', 0); ?>" /></td><td style="border-right:3px solid black;"></td></tr>
                    <tr><td style="border-left:3px solid black;"><?php echo JText::_('CLS_OHS_ESCAPE_OF_A_SUBSTANCE_INTO_THE_ATMOSPHERE'); ?>             </td><td><input type="text" onchange="recalculateRates()" name="escape_of_a_substance_into_the_atmosphere" size="1" maxlength="5" value="<?php echo $this->session->get('cls_escape_of_a_substance_into_the_atmosphere', 0); ?>" /></td><td style="border-right:3px solid black;"></td></tr>
                    <tr><td style="border-left:3px solid black;"><?php echo JText::_('CLS_OHS_UTILITY_OR_SERVICE_STRIKE'); ?>                             </td><td><input type="text" onchange="recalculateRates()" name="utility_or_service_strike" size="1" maxlength="5" value="<?php echo $this->session->get('cls_utility_or_service_strike', 0); ?>" /></td><td style="border-right:3px solid black;"></td></tr>
                    <tr><td style="border-left:3px solid black;"><?php echo JText::_('CLS_OHS_DAMAGE_TO_PUBLIC_PROPERTY_OR_EQUIPMENT'); ?>                </td><td><input type="text" onchange="recalculateRates()" name="damage_to_public_property_or_equipment" size="1" maxlength="5" value="<?php echo $this->session->get('cls_damage_to_public_property_or_equipment', 0); ?>" /></td><td style="border-right:3px solid black;"></td></tr>
                    <tr><td style="border-left:3px solid black;"><?php echo JText::_('CLS_OHS_DAMAGE_TO_CONTRACTORS_EQUIPMENT'); ?>                       </td><td><input type="text" onchange="recalculateRates()" name="damage_to_contractors_equipment" size="1" maxlength="5" value="<?php echo $this->session->get('cls_damage_to_contractors_equipment', 0); ?>" /></td><td style="border-right:3px solid black;"></td></tr>
                    <tr><td style="border-left:3px solid black;"><?php echo JText::_('CLS_OHS_WORKER_LEAVING_SITE_DUE_TO_SAFETY_CONCERNS'); ?>            </td><td><input type="text" onchange="recalculateRates()" name="worker_leaving_site_due_to_safety_concerns" size="1" maxlength="5" value="<?php echo $this->session->get('cls_worker_leaving_site_due_to_safety_concerns', 0); ?>" /></td><td style="border-right:3px solid black;"></td></tr>
                    <tr><td style="border-left:3px solid black;"><?php echo JText::_('CLS_OHS_STAFF_ON_REDUCED_ALTERNATE_DUTIES'); ?>                     </td><td><input type="text" onchange="recalculateRates()" name="staff_on_reduced_alternate_duties" size="1" maxlength="5" value="<?php echo $this->session->get('cls_staff_on_reduced_alternate_duties', 0); ?>" /></td><td style="border-right:3px solid black;"></td></tr>
                    ...
                    <tr><th style="border-left:3px solid black;border-bottom:3px solid black;"><?php echo JText::_('CLS_OHS_OVERALL_TOTAL'); ?>                                         </th><td id="total_overall" style="border-bottom:3px solid black;padding:5px;"></td><td style="border-right:3px solid black;border-bottom:3px solid black;"></td></tr>
                </table>
            </td>
        </tr>
        <tr>
...
function recalculateRates() {
    ...
    document.getElementById('total_rate').innerText = (+document.getElementById('total_number').innerText / hours).toFixed(2);

    // lagging indicators
    document.getElementById('rate_fatal_injuries').innerText =                                              (+document.report_form.fatal_injuries.value / hours * 1000000).toFixed(2);
    document.getElementById('rate_notifiable_injuries_or_incidents').innerText =                            (+document.report_form.notifiable_injuries_or_incidents.value / hours * 1000000).toFixed(2);
    document.getElementById('rate_lost_time_injuries_or_illnesses').innerText =                             (+document.report_form.lost_time_injuries_or_illnesses.value / hours * 1000000).toFixed(2);
    document.getElementById('rate_medically_treated_injuries_or_illnesses').innerText =                     (+document.report_form.medically_treated_injuries_or_illnesses.value / hours * 1000000).toFixed(2);
    document.getElementById('rate_first_aid_injuries').innerText =                                          (+document.report_form.first_aid_injuries.value / hours * 1000000).toFixed(2);
    document.getElementById('rate_injury_with_no_treatment').innerText =                                    (+document.report_form.injury_with_no_treatment.value / hours * 1000000).toFixed(2);
    ...
    document.getElementById('rate_total_fatalities_and_injuries').innerText = +document.getElementById('total_fatalities_and_injuries').innerText / hours;
